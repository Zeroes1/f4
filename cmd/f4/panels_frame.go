...
func (pf *PanelsFrame) HandleCommand(cmd int, args any) bool {
	...
	case CmPanelSettings:
		openSettingsCenter("panels")
		return true
	case CmEditorSettings:
		openSettingsCenter("editor")
		return true
	case CmColorerSettings:
		openSettingsCenter("syntax")
		return true
	case CmAppearanceSettings:
		openSettingsCenter("appearance")
		return true
	case CmConfirmationsSettings:
		openSettingsCenter("operations")
		return true
	case CmHotkeyConfig:
		openSettingsCenter("keyboard")
		return true
	case CmLanguage:
		openSettingsCenter("appearance")
		return true
	...
	case CmUpdateSettings:
		openSettingsCenter("updates")
		return true
	case CmProxySettings:
		openSettingsCenter("network")
		return true
	case CmPlugins:
		openSettingsCenter("plugins")
		return true
